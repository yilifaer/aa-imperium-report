# Generated migration for aa_imperium_report v0.2
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id",          models.AutoField(primary_key=True, serialize=False)),
                ("report",      models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="imp_attendance", to="aa_imperium_report.monthlyreport")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id",                 models.AutoField(primary_key=True, serialize=False)),
                ("report",             models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name="imp_esi", to="aa_imperium_report.monthlyreport")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id",                    models.AutoField(primary_key=True, serialize=False)),
                ("report",                models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="corp_stats",   to="aa_imperium_report.monthlyreport")),
                ("corporation",           models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="eveonline.evecorporationinfo")),
                ...
                ("imp_esi_status",        models.CharField(choices=[("PASS","PASS"),("FAIL","FAIL"),("NO_TOKEN","NO_TOKEN"),("UNKNOWN","UNKNOWN")], default="UNKNOWN", max_length=16)),
            ...
            options={"ordering": ("-imp_fleet_str",)},
        ),
        migrations.AddConstraint(
            model_name="corpmonthlystat",
            constraint=models.UniqueConstraint(fields=["report", "corp_name"], name="unique_report_corp"),
        ) if False else migrations.AlterUniqueTogether(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id",                    models.AutoField(primary_key=True, serialize=False)),
                ("report",                models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name="member_stats", to="aa_imperium_report.monthlyreport")),
            ...
            options={"ordering": ("-igc_fleet_str",)},
        ),
